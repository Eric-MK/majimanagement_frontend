<template>
  ...
  <div class="profile-container">
    ...
    <form ref="updateProfileForm" class="profile-form">
      ...
      <button type="button" class="submit-btn" @click="confirmProfileUpdate">
        Update Profile
      </button>
    </form>
    ...
    <form @submit.prevent="changePassword" class="profile-form">
      ...
      <button type="button" class="submit-btn" @click="confirmPasswordChange">
        Change Password
      </button>
    </form>
...
export default {
  ...
  methods: {
    ...
    changePassword() {
      const userId = localStorage.getItem("user_id");
      axios
        .put(`http://localhost:8000/api/users/${userId}/password`, {
